...
public class Runner {
    ...
    public static void main(String[] args) {
        ...
        Airport cargoAirport = new Airport(airport.getCargoPlanes());
        ...
        System.out.println("Cargo airport sorted by max load capacity: " + cargoAirport.sortByMaxLoadCapacity().toString());
